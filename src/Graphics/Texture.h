...
namespace Lumen
{
	...
	public:
		...
		void CreateTexture(int w, int h, GLenum internalFormat, GLenum format, GLenum type, bool mipmap, bool flip,
			GLenum min_filter, GLenum mag_filter, GLenum texwrap_s, GLenum texwrap_t);
